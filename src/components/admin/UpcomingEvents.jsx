        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100/80">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">Events with highest priority</p>
                </div>
            ...
            {upcomingEvents.length > 0 ? (
                <div className="space-y-4">
                    {upcomingEvents.map((event, index) => {
                        ...
                        return (
                            <div key={event.id} className="group p-4 rounded-xl bg-gray-50/70 hover:bg-gray-50 transition-colors">
                                <div className="flex items-start justify-between mb-2">
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            ...
                                            <span className="text-xs font-bold text-indigo-600 uppercase">{event.sport}</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-bold text-gray-600 whitespace-nowrap">{fillPct}%</span>
                                </div>
                            </div>
                        );
                    })}
